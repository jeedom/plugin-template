...
class ATTESTGEN {
    ...
    public static function convert_pdf_to_png($fileURL){
        ...
        $cmdIg ='convert -density 200 '.$fileURL.'[0] -fill "#FFFFFFFF" -opaque none -flatten -alpha flatten -alpha remove -colorspace RGB -define profile:skip=ICC '.$basePath.'/'.$pngName;
